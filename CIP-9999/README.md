...
A CPS must be stored in a specific folder named after its number and in a file called `README.md`. Before a number is assigned, use `????` as a placeholder name.
...
##### [1.a. Authors open pull requests with their problem statement](https://cips.cardano.org/cips/cip1#authors-a-open-pull-requests)

##### [1.b. Authors seek feedback](https://cips.cardano.org/cips/cip1#authors-seek-feedback)

#### 2. Editors' role (same as CIP-0001)

##### [2.a. Triage in bi-weekly meetings](https://cips.cardano.org/cips/cip1##triage-in-bi--weekly-meetings)

##### [2.b. Reviews](https://cips.cardano.org/cips/cip1#reviews)
...
Once merged, authors, code owners, or any other ecosystem actors may propose solutions addressing the problem in the form of CIP. They add their CIP to the _'Proposed Solutions'_ field in the CPS' _'Preamble'_ once a solution has been fully implemented and reaches the goals fixed in the original statement.
